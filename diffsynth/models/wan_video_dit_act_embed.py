...
class WanModel(torch.nn.Module):
    def __init__(
        ...
        self.action_alpha = nn.Parameter(torch.tensor(action_alpha))
    ...
    def forward(self,
                ...
                action: Optional[torch.Tensor] = None,  # 新增action输入
                **kwargs,
                ):
        ...
        scaled_action = action_emb * self.action_alpha
        # print("Action Embedding Stats (After Scaling):")
        # print("  Mean:", scaled_action.mean().item(), " Std:", scaled_action.std().item(), " Min:", scaled_action.min().item(), " Max:", scaled_action.max().item())
