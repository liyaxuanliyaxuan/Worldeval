...
python train_wan_t2v_act_embed.py \
  ...
  --dataset_path data/onehot_example_dataset \
  --output_path ./models \
  ...
  --lora_rank 16 \
  --lora_alpha 16 \
  --lora_target_modules "q,k,v,o,ffn.0,ffn.2,action_alpha,action_proj.0,action_proj.2,action_proj.4"\
  --accumulate_grad_batches 1 \
  --use_gradient_checkpointing \
  --action_alpha 0.3 \
  --action_dim 224 \
  --version "lora_act_alpha_0.3_onehot_v2" \
  --encode_mode "onehot" \
  --action_encoded_path data/onehot_example_dataset/actions.pt